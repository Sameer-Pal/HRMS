...
# Variable crete -- sql
        ...
        lbl_title=Label(self.root,text="Team Mate",font=("times new roman",37,"bold"),fg='darkblue', bg='white' )
        lbl_title.place(x=0,y=0,width=1530,height=50)

        img_logo=Image.open("images/lgog.jpg")
        img_logo=img_logo.resize((60,60),Image.Resampling.LANCZOS)
        self.photo_logo=ImageTk.PhotoImage(img_logo)
        
        self.logo = Label(self.root, image=self.photo_logo)  
        self.logo.place(x=580,y=0,width=50,height=50)  
        ...
        img_main=Image.open("images/just4you_main.jpg")
